...
var db = (function () {
    ...
    function init() {
        ...
        b = a.then (
            function() {
                m = fdb.collection("members")
                    .where("id.gender", "==", "M")
                    .get()
                    .then(
                        // fulfillment handler
                        function (myData) {
                            console.log("get males success");
                            males = myData;
